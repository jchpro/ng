...
/**
 * Extends your directive with {@link Reactive} and make observing
 ...
 */
@Directive({})
export class Reactive implements OnDestroy {

  protected readonly destroySubject = new Subject<void>();

  /**
   * Call in the extending directive if you have your own implementation.
   */
  ngOnDestroy() {
  ...
  /**
   * Observe the reactive stream until the directive gets destroyed.
   */
